...
be0 = double(fi(b0_f*ek,1,34,23));
be1 = double(fi(b1_f*ek1,1,34,22));
be2 = double(fi(b2_f*ek2,1,34,23));
au1 = double(fi(a1_f*uk1,1,45,33));
au2 = double(fi(a2_f*uk2,1,44,34));
be01 = double(fi(be0+be1,1,50,36));
be012 =double(fi( be01+be2,1,51,40,res_a));
au12 = double(fi(au1+au2,1,46,34,res_a));
uk = fi(be012 - au12,un);
