...
be0 = fi(b0*ek,1,34,23);
%(para eso usar�a fi()), sino c�mo se operar� en adelante con este objeto
be1 = fi(b1*ek1,1,34,22);
be2 = fi(b2*ek2,1,34,23);
au1 = fi(a1*uk1,1,50,33);
au2 = fi(a2*uk2,1,48,34);

be01 = fi(be0+be1,1,34,23);
be012 = fi(be01+be2,1,59,40);
au12 = fi(au1+au2,1,49,34);
