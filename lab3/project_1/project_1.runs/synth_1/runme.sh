...
HD_PWD='C:/Users/chris/Master/DCD/Lab3/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mult_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mult_test.tcl
