...
HD_PWD='C:/Users/chris/Masterr/DCD/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mult_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mult_test.tcl -notrace
