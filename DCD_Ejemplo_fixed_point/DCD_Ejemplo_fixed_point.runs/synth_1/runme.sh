...
HD_PWD='C:/Users/chris/Masterr/DCD/DCD_Ejemplo_fixed_point/DCD_Ejemplo_fixed_point.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Multiplicacion_fixed_point.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Multiplicacion_fixed_point.tcl
