...
HD_PWD='C:/Aitor/UPV-EHU Fisika+IE/MSTER/DCD/Sesion_4/lab4_MagLev_copia2/lab4_MagLev_copia2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_controller.tcl -notrace
