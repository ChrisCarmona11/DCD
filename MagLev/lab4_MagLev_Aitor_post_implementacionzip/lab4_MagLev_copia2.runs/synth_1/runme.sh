...
HD_PWD='C:/Aitor/UPV-EHU Fisika+IE/MSTER/DCD/Sesion_4/lab4_MagLev_copia2/lab4_MagLev_copia2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_controller.tcl
