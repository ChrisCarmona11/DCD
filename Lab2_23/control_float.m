...
%Periodo de muestreo seleccionado (el ejercicio pide 1ms)
T2 = 1E-3;

%Discretizamos el controlador
%_____error de koldo__________________________________________________
...
setpoints = [pi/2*ones(pasos/2,1);-pi/2*ones(pasos/2,1)];
